class User::CategoriesController < UserController
  ...
  def destroy
    ...
    @category.destroy
    respond_to do |format|
      format.html { redirect_to user_categories_url, notice: "Kategoria usunieta wraz z PRODUKTAMI POWIAZANYMI - usunieto produktow #{@items.count}" }#<strong>postami</strong>" }
      format.json { head :no_content }
    end
  end
